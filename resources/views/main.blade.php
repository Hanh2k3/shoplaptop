...
<body>
						...
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								@elseif (($customer_id!=null) && ($shipping_id !=null))
										<li><a href="{{route('checkout.payment')}}"><i class="fa fa-crosshairs"></i>Thanh toán</a></li>
									@else
										<li><a href="{{route('checkout.login_checkout')}}"><i class="fa fa-crosshairs"></i>Thanh toán</a></li>
								@endif
								...
								@else
									<li><a href="{{route('checkout.login_checkout')}}"><i class="fa fa-lock"></i> Đăng nhập</a></li>
								@endif
							</ul>
						</div>
					</div>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{asset('frontendimages/home/girl3.jpg')}}" class="girl img-responsive" alt="" />
									<img src="{{asset('frontendimages/home/pricing.png')}}" class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									@foreach ($list_categories as $category) 
										<li><a href="{{route('home.category', ['id' => $category->id])}}">{{$category->name}}</a></li>
									@endforeach
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									@foreach ($list_brand as $brand) 
										<li><a href="{{route('home.brand', ['id' => $brand->id])}}">{{$brand->name}}</a></li>
									@endforeach
	...
	<div id="fb-root"></div>
	<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0" nonce="e41o9BsJ">
	</script>
