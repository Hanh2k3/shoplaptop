            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Keyword của danh mục :</label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Mô ta của keyword</label>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control input-sm m-bot15" name='category_status'>
                                <option value="1" {{old('category_status')==0?'selected="true"':false}} >Ẩn</option>
                                <option value="0" {{old('category_status')==1?'selected="true"':false}}>Hiện</option>                            
                            </select>
