                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="image" id="exampleInputEmail1" value="{{old('image')}}"placeholder="Tên danh mục ....">
                            @error('image')
                                <p style="color:red; ">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control"  name="product_desc" id="ck1" >
                                {{old('product_desc')}}
                            </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control"  name="product_content" id="ck2">
                                {{old('product_content')}}
                            </textarea>
