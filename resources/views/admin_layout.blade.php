			...
			<div class="leftside-navigation">
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu">
						...
						<ul class="sub">
							<li><a href="{{route('manager_order.')}}">Tất cả đơn hàng</a></li>
							<li><a href="{{route('category.all')}}">Liệt kê danh mục </a></li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul class="sub">
							...
							<li><a href="{{route('brand.all')}}">Liệt thương hiệu </a></li>
						</ul>
					</li>
					...
					<li class="sub-menu">
						...
						<ul class="sub">
							...
							<li><a href="{{route('product.all')}}">Liệt sản phẩm </a></li>
						</ul>
					</li>
				</ul>            
			</div>
